...
<Callout type="tip">
  Quick Open caches the project file index after the first open, so subsequent opens are instant.
  The index refreshes automatically when you switch projects.
</Callout>
