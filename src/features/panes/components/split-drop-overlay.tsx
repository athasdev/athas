  ...
  return (
    ...
    >
      {effectiveZone && (
        <div
          className={cn(
            "pointer-events-none absolute border-2 border-primary bg-primary-soft shadow-[0_0_0_1px_var(--primary)] transition-[inset,width,height,opacity,transform] duration-fast ease-smooth",
