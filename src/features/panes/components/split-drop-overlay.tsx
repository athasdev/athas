  ...
  return (
    ...
    >
      {effectiveZone && (
        <div
          className={cn(
            "pointer-events-none absolute border-2 border-primary bg-primary-soft ring-1 ring-primary transition-[inset,width,height,opacity,transform] duration-fast ease-smooth",
