  ...
  return (
    ...
    >
      {effectiveZone && (
        <div
          className={cn(
            "pointer-events-none absolute border-2 border-primary bg-primary/14 shadow-[0_0_0_1px_var(--primary)] transition-[inset,width,height,opacity,transform] duration-[var(--app-duration-fast)] ease-[var(--app-ease-smooth)]",
