import "@/features/editor/engines/athas/styles/overlay-editor.css";
import {
  type ReactNode,
  type RefObject,
  useCallback,
...
import { useAutocomplete } from "@/features/editor/engines/athas/hooks/use-autocomplete";
import { useAthasEditorTokens } from "@/features/editor/engines/athas/hooks/use-athas-editor-tokens";
import { useBufferSwitch } from "@/features/editor/engines/athas/hooks/use-buffer-switch";
import { useContextMenu } from "@/features/editor/engines/athas/hooks/use-context-menu";
import { useDragScroll } from "@/features/editor/engines/athas/hooks/use-drag-scroll";
import { useEditorCursorSelection } from "@/features/editor/engines/athas/hooks/use-editor-cursor-selection";
import { useEditorKeyDown } from "@/features/editor/engines/athas/hooks/use-editor-keydown";
import { useEditorOperations } from "@/features/editor/engines/athas/hooks/use-editor-operations";
import { useEditorScroll } from "@/features/editor/engines/athas/hooks/use-editor-scroll";
import { useEditorSurfaceResolvers } from "@/features/editor/engines/athas/hooks/use-editor-surface-resolvers";
import { useEditorTextareaInput } from "@/features/editor/engines/athas/hooks/use-editor-textarea-input";
import { useEditorViewLayout } from "@/features/editor/engines/athas/hooks/use-editor-view-layout";
import { useEditorWheelForwarding } from "@/features/editor/engines/athas/hooks/use-editor-wheel-forwarding";
import { useEnsureCursorVisible } from "@/features/editor/engines/athas/hooks/use-ensure-cursor-visible";
import { useFoldRegionScheduler } from "@/features/editor/engines/athas/hooks/use-fold-region-scheduler";
import { useFoldTransform } from "@/features/editor/engines/athas/hooks/use-fold-transform";
import { useInlineDiff } from "@/features/editor/engines/athas/hooks/use-inline-diff";
import { useEditorLineModel } from "@/features/editor/engines/athas/hooks/use-editor-line-model";
import { useInlayHintSuppression } from "@/features/editor/engines/athas/hooks/use-inlay-hint-suppression";
import { useLargeEditorInput } from "@/features/editor/engines/athas/hooks/use-large-editor-input";
...
import { useEditorMouseInteractions } from "@/features/editor/engines/athas/hooks/use-editor-mouse-interactions";
import { usePerformanceMonitor } from "@/features/editor/engines/athas/hooks/use-performance";
import { useResolvedEditorSettings } from "@/features/editor/engines/athas/hooks/use-resolved-settings";
import { useSelectionScope } from "@/features/editor/engines/athas/hooks/use-selection-scope";
import { useTokenizationScheduler } from "@/features/editor/engines/athas/hooks/use-tokenization-scheduler";
import { getLanguageId, useTokenizer } from "@/features/editor/engines/athas/hooks/use-tokenizer";
import {
  expandViewportRange,
  useViewportLines,
...
import { applyVirtualEdit, calculateActualOffset } from "@/features/editor/utils/fold-transformer";
import { fileOpenBenchmark } from "@/features/editor/utils/file-open-benchmark";
import {
  applyIncrementalLineOffsetEdit,
  buildLineOffsetMap,
  normalizeLineEndings,
} from "@/features/editor/utils/html";
import { resolveInlineAutocompletePreview } from "@/features/editor/engines/athas/utils/inline-autocomplete-preview";
import {
...
import { InlineDiff } from "@/features/editor/engines/athas/components/diff/inline-diff";
import { Gutter } from "@/features/editor/engines/athas/components/gutter/gutter";
import {
  InlineAutocompleteHint,
  InlineAutocompletePreview,
} from "@/features/editor/engines/athas/components/inline-autocomplete-preview";
import { LargeEditorSurface } from "@/features/editor/engines/athas/components/large-editor-surface";
import { BracketMatchLayer } from "@/features/editor/engines/athas/components/layers/bracket-match-layer";
import { CurrentLineLayer } from "@/features/editor/engines/athas/components/layers/current-line-layer";
import { DefinitionLinkLayer } from "@/features/editor/engines/athas/components/layers/definition-link-layer";
import { GitBlameLayer } from "@/features/editor/engines/athas/components/layers/git-blame-layer";
import { HighlightLayer } from "@/features/editor/engines/athas/components/layers/highlight-layer";
import { IndentGuideLayer } from "@/features/editor/engines/athas/components/layers/indent-guide-layer";
import { InputLayer } from "@/features/editor/engines/athas/components/layers/input-layer";
import { MultiCursorLayer } from "@/features/editor/engines/athas/components/layers/multi-cursor-layer";
import { PrimaryCursorLayer } from "@/features/editor/engines/athas/components/layers/primary-cursor-layer";
import { SearchHighlightLayer } from "@/features/editor/engines/athas/components/layers/search-highlight-layer";
import { SelectionLayer } from "@/features/editor/engines/athas/components/layers/selection-layer";
import { VimCursorLayer } from "@/features/editor/engines/athas/components/layers/vim-cursor-layer";
import { WordHighlightLayer } from "@/features/editor/engines/athas/components/layers/word-highlight-layer";
import { Minimap } from "@/features/editor/engines/athas/components/minimap/minimap";

interface AthasEditorProps {
  bufferId?: string;
  viewStateKey?: string;
