...
import { calculateLineColumnFromOffsets } from "@/features/editor/utils/position";
import type { EditorViewLayout, ViewLineSegment } from "@/features/editor/view-model/view-layout";
