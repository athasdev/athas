...
export const settingsSearchIndex: SettingSearchRecord[] = [
  ...
  {
    id: "ai-pi-provider-auth",
    tab: "ai",
    section: "Provider Auth",
    label: "Provider Auth",
    description: "Manage shared Pi OAuth sessions and API keys from the AI tab",
    keywords: ["pi", "auth", "oauth", "api key", "providers", "shared auth.json"],
  },
  {
    id: "ai-pi-default-provider",
    tab: "ai",
    section: "Pi Defaults",
    label: "Default Provider",
    description: "Choose the global or project default provider for Pi-native sessions",
    keywords: ["pi", "provider", "default", "global", "project", "inherit"],
  },
  {
    id: "ai-pi-default-model",
    tab: "ai",
    section: "Pi Defaults",
    label: "Default Model",
    description: "Choose the global or project default model for Pi-native sessions",
    keywords: ["pi", "model", "default", "global", "project", "inherit"],
  },
  {
    id: "ai-pi-thinking-level",
    tab: "ai",
    section: "Pi Defaults",
    label: "Thinking Level",
    description: "Set the default reasoning level for Pi-native sessions",
    keywords: ["pi", "thinking", "reasoning", "defaults", "global", "project"],
  },
  {
    id: "ai-pi-packages",
    tab: "ai",
    section: "Packages & Resources",
    label: "Pi Packages",
    description: "Install and remove shared Pi packages and inspect discovered resources",
    keywords: ["pi", "packages", "extensions", "skills", "prompts", "themes", "resources"],
  },
  {
    id: "ai-pi-advanced-files",
    tab: "ai",
    section: "Advanced Files",
    label: "Open Pi Config Files",
    description: "Open the real shared Pi settings, auth, models, and project files in Athas",
    keywords: ["pi", "settings.json", "auth.json", "models.json", "advanced", "files"],
  },
