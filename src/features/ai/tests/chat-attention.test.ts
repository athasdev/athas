...
function authRequest(sessionId: string | null, phase: AcpAuthRequest["phase"]): AcpAuthRequest {
  return {
    agentId: "agent",
    sessionId,
    methods: [],
...
const idle = { sessionId: "s1", pendingPermissions: 0, questions: [], authRequest: null };
