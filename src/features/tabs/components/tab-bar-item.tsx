  ...
  return (
    <>
      ...
      <div
        ...
        className={cn(
          "group relative flex shrink-0 cursor-pointer select-none items-center gap-1 whitespace-nowrap border-border border-r px-2 py-1 transition-[transform,opacity] duration-200 ease-[ease]",
          isActive ? "bg-primary-bg" : "bg-secondary-bg hover:bg-hover",
