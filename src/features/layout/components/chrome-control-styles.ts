...
export const chromeControl = cva(
  "athas-chrome-control min-h-6 min-w-7 rounded-[var(--app-radius-control-sm)] border-0 bg-transparent leading-[1.35] focus-visible:rounded-[var(--app-radius-control-sm)] [&_svg]:size-4 [&_svg]:min-h-4 [&_svg]:min-w-4",
  {
    variants: {
      shape: {
        icon: "w-7 px-0",
