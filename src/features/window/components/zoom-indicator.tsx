...
export function ZoomIndicator() {
  ...
  return (
    <div className="fade-in-0 fade-out-0 fixed top-4 right-4 z-50 animate-in animate-out rounded bg-black/80 px-2 py-1 text-white ui-text-xs backdrop-blur-sm duration-200">
