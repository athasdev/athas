  ...
  ({
    ...
    return createPortal(
      ...
      >
        <div className="mb-2">
          ...
          <div className="flex items-center justify-between text-text-lighter">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded bg-primary-bg px-2 py-0.5 font-mono text-[8px] transition-colors hover:bg-hover"
            >
              <Hash size={6} />
        ...
        {isLoading ? (
          <div className="italic text-text-lighter">Loading files...</div>
        ) : files.length === 0 ? (
          <div className="italic text-text-lighter">No files changed</div>
        ) : (
