...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center text-subtle-foreground group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col",
  {
    variants: {
      variant: {
        default:
          "gap-(--athas-chrome-gap-tight) rounded-(--athas-chrome-radius) bg-surface/55 p-0.5",
        segmented:
          "min-h-(--athas-chrome-control-height) items-stretch overflow-hidden rounded-(--athas-chrome-radius) bg-surface/55",
