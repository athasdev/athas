...
const switchClassName =
  "group/switch relative inline-flex h-3.5 w-7 shrink-0 items-center rounded-full border border-border bg-surface p-px outline-none transition-[transform,background-color,border-color,box-shadow] duration-normal ease-smooth data-checked:border-primary data-checked:bg-primary active:scale-press focus-visible:border-border-strong focus-visible:ring-1 focus-visible:ring-border-strong/35 data-disabled:cursor-not-allowed data-disabled:opacity-50";
